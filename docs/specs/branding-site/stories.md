...
authors: [story-writer, story-skeptic]
review_rounds: 2
---
...
- Platform choice is left to the implementation team. Choose based on embeddable form support and segmentation capability.
...
- **P1-16 Analytics** (Story 3): Must be installed before signup forms go live to ensure all conversions are tracked from day one.
- **Privacy Policy page** (Story 12): Required for CAN-SPAM/GDPR compliance on all email signup forms. Must be live before any signup form goes live.
